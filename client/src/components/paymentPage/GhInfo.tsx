      ...
      {ghData.url && (
        <div className="flex w-full pb-[20px] border-b border-border-color mb-[20px]">
          <img
            src={ghData.url}
            alt=""
            className="w-[80px] h-[60px] mr-[10px] md:mr-[30px] rounded-CommentRadius md:w-[240px] md:h-[160px] md:rounded-ImgRadius"
          />
          <div className="flex flex-col justify-between">
            <p className="font-bold text-base md:text-xl">{ghData.ghname}</p>
            <div className="flex items-center">
              {ghData.ratedScore && <RatedStar star={ghData.ratedScore} />}
