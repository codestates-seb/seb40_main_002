...
function Door() {
  ...
  return (
    <div
      className={`transition-all duration-[1500ms] ${opacity} ease-out fixed z-[100] flex justify-center items-center w-[100vw] h-[100vh] bg-no-repeat bg-center bg-cover bg-[url('https://cdn.pixabay.com/photo/2016/11/18/07/45/mark-1833559_1280.jpg')]`}
    >
