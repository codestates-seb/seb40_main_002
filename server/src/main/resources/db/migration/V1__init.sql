...
CREATE TABLE `guest_house` (
  ...
  `create_at` datetime(6) DEFAULT NULL,
  `modified_at` datetime(6) DEFAULT NULL,
  `guest_house_address` varchar(255) NOT NULL,
  `guest_house_info` varchar(255) NOT NULL,
  `guest_house_location` varchar(255) NOT NULL,
  `guest_house_name` varchar(255) NOT NULL,
  `guest_house_phone` varchar(255) NOT NULL,
  `guest_house_review_count` bigint NOT NULL,
  `guest_house_star` float NOT NULL,
...
CREATE TABLE `room_reservation` (
  ...
  `create_at` datetime(6) DEFAULT NULL,
  `modified_at` datetime(6) DEFAULT NULL,
  `room_reservation_end` date NOT NULL,
  `room_reservation_start` date NOT NULL,
