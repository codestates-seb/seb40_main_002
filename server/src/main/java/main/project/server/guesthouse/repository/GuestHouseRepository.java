...
//                    " (ghrr.room_reservation_start <= :start AND ghrr.room_reservation_end >= :start" + //---
//                    " AND ghrr.room_reservation_start <= :end AND ghrr.room_reservation_end <= :end ) OR" +
//                    " (ghrr.room_reservation_start >= :start AND ghrr.room_reservation_end >= :start" +
//                    " AND ghrr.room_reservation_start <= :end AND ghrr.room_reservation_end <= :end ) OR" +
//                    " (ghrr.room_reservation_start >= :start AND ghrr.room_reservation_end >= :start" +
//                    " AND ghrr.room_reservation_start <= :end AND ghrr.room_reservation_end >= :end ) OR" +
//                    " (ghrr.room_reservation_start <= :start AND ghrr.room_reservation_end >= :start" +
//                    " AND ghrr.room_reservation_start <= :end AND ghrr.room_reservation_end >= :end )" +
//                    " )" +
//                    " GROUP BY gh.guest_house_id",
